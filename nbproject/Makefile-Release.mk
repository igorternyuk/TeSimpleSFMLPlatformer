...
# CC Compiler Flags
CCFLAGS=-std=c++17 -lsfml-graphics -lsfml-audio
CXXFLAGS=-std=c++17 -lsfml-graphics -lsfml-audio
...
${OBJECTDIR}/MapManager.o: MapManager.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MapManager.o MapManager.cpp
